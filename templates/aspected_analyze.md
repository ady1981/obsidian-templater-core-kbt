...
const calcAIFunction = async () => {     
     ...
     //
     const response = await client.aspected_analyze(tp, content, knowledge_topic, target_semantic_specification2, information_retrieval_strategy2, output_generation_strategy2, extra_output_specification2, meta);
