...
const task_specification = {
  Task_type: 'abstractive summarize'
}
...
const calcAIFunction = async () => {
     ...
     const knowledge_source = client.encodeInMarkdown(selection, 'md');
     ...
     //
     const response = await client.contextual_generate(tp, task_specification2, target_semantic_specification2, knowledge_topic, knowledge_source, information_retrieval_strategy2, output_generation_strategy2, extra_output_specification2, meta);
