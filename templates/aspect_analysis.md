...
const calcAIFunction = async () => {
    ...
    const analysis_strategy = null;
    const examples = null;
    const response = await tp.user.client.aspect_based_analysis(tp, content, content_topic, extra_output_specification, analysis_scope, analysis_strategy, examples);
