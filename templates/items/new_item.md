...
//  Facts_based_on_reliable_sources: true,
   ...
   Focus_on: 'non-creative tasks',
   '**Take_into_account**': 'These are wrong new items: machine_translation (because it\'s a subtask of constrained_text_rewriting), question_generation (because it\'s creative task)',
...
//  Item_format: 'same as other items',
  Number_of_items: 'to_complete_Universe_of_Discourse'
};
const meta = {
